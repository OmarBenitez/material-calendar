		$('.month-item').click(function(e){	
			...
			// generar efecto material
			var parent, ink, d, x, y;
			parent = $('.view-year');
			//crea elemento .ink si no existe
			...
			{
				//usa el ancho y el alto del padre para que el circulo sea siempre mayor
			...
			//establece posicion y añade la clase .animate
